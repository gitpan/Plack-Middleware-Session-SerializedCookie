...
#     NAME => q[Plack::Middleware::Session::SerializedCookie]
#     NO_META => q[1]
#     PL_FILES => {  }
...
MAKE = make
FULLEXT = Plack/Middleware/Session/SerializedCookie
BASEEXT = SerializedCookie
PARENT_NAME = Plack::Middleware::Session
DLBASE = $(BASEEXT)
VERSION_FROM = 
OBJECT = 
LDFROM = $(OBJECT)
...
H_FILES  = 
MAN1PODS = 
MAN3PODS = lib/Plack/Middleware/Session/SerializedCookie.pm

# Where is the Config information that we are using/depend on
CONFIGDEP = $(PERL_ARCHLIB)$(DFSEP)Config.pm $(PERL_INC)$(DFSEP)config.h

# Where to build things
INST_LIBDIR      = $(INST_LIB)/Plack/Middleware/Session
INST_ARCHLIBDIR  = $(INST_ARCHLIB)/Plack/Middleware/Session
...
TO_INST_PM = lib/Plack/Middleware/Session/SerializedCookie.pm

PM_TO_BLIB = lib/Plack/Middleware/Session/SerializedCookie.pm \
...
manifypods : pure_all  \
	lib/Plack/Middleware/Session/SerializedCookie.pm
	$(NOECHO) $(POD2MAN) --section=$(MAN3EXT) --perm_rw=$(PERM_RW) \
	  lib/Plack/Middleware/Session/SerializedCookie.pm $(INST_MAN3DIR)/Plack::Middleware::Session::SerializedCookie.$(MAN3EXT) 
...
pm_to_blib : $(FIRST_MAKEFILE) $(TO_INST_PM)
	$(NOECHO) $(ABSPERLRUN) -MExtUtils::Install -e 'pm_to_blib({@ARGV}, '\''$(INST_LIB)/auto'\'', q[$(PM_FILTER)], '\''$(PERM_DIR)'\'')' -- \
	  lib/Plack/Middleware/Session/SerializedCookie.pm blib/lib/Plack/Middleware/Session/SerializedCookie.pm 
